...
export default function Search(props: { data: any }) {
  ...
  return (
    <>
      <Head>
        <title>Quests | Voidpet Wiki</title>
        <meta name="title" content="Quests | Voidpet Wiki" />
        <meta name="description" content="See a list of quests on voidpet." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://wiki.voidpet.io" />
        <meta property="og:title" content="Quests | Voidpet Wiki" />
        <meta
          property="og:description"
          content="See a list of quests on voidpet."
        />
        <meta property="twitter:url" content="https://wiki.voidpet.io" />
        <meta property="twitter:title" content="Quests | Voidpet Wiki" />
        <meta
